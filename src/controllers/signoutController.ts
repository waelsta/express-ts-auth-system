...
export async function signout(req:Request, res:Response, next:NextFunction){
    ...
    try {
        ...
        return res.send({"data":"signed out successfully"}).status(StatusCodes.NO_CONTENT);
    } catch {
        return next(new CustomError(StatusCodes.INTERNAL_SERVER_ERROR,"couldn't sign out.. try again"))
    }
  }